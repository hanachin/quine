...
){A.new(W){'x'}};i=0;nm.each_wxx    _/. . \    xxxxx~|r,y|r.each_with_index{|c,n
]||'#';i+=1}};tts=ts.select{|txx    \___  /     xxx//to?(:n)};tts.aaaaaaaaaaaaaa
nm[y][x]="\x1b[48;5;%dm%sxxxxxx   >~~\=/ /       xxx\x1b[0m"%xxt.p,nm[y][x]]}};m
include?(@1.b.first)&&@xxxxxxxx       | /        xx;@1.b.include?(@2.b.first)&&@
);fs.each{m[@1][@2]="\x1bxxxxxx       | |__/|    xx[48;5;0m%s\x1b[0m"%m[@1][@2]}
index{|r,y|"\x1b[#{y+1};1H\xxxxx       \_____/   xx|"+r.join}.join);sleep(0.1)}}
